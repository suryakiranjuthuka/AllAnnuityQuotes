...
<header class="bottomShadow"> <!--class="bottomShadow"-->
    ...
    <div class=" headerInsetShadow" id="headerContainer">
...
<!--*************************************************************** Start Calculator ******************************************************-->
<section class="calculatorHover" id="annuityCalculatorContainer">
	<h1>Calculate My Payouts</h1>
    
    
    <div id="centerCalculatorContainer">
    
    
    	<div class="md-content2" id="calculatorForm">
